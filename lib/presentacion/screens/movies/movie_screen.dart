...
import 'package:cinemapedia/presentacion/providers/actors/actors_bymovie_providers.dart';
...
class MovieScreenState extends ConsumerState<MovieScreen> {
  ...
  void initState() {
    ...
    ref.read(actorByMovieProviders.notifier).loadActors(widget.movieid);
  }
...
class _ActorByMovie extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    final actorsByMovie = ref.watch(actorByMovieProviders);
